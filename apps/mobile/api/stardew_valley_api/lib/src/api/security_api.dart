...
class SecurityApi {
  ...
  const SecurityApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LoginUserResponse] as data
  ...
  Future<Response<LoginUserResponse>> loginUser({
    ...
    LoginUserResponse? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RefreshTokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [VerifyUserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VerifyUserResponse>> verifyUser({
    required VerifyUserRequest verifyUserRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    VerifyUserResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(VerifyUserResponse),
    ...
    return Response<VerifyUserResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
