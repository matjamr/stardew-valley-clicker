...
Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(CreateEventResponse.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AnimalPen)]),
          () => ListBuilder<AnimalPen>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(MineTile)]),
          () => ListBuilder<MineTile>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => ListBuilder<String>())
      ..addBuilderFactory(
