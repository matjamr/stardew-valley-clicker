...
import com.mat.jamr.userservice.security.service.refresh.RefreshSecurityContext;
...
public class SecurityService extends SecurityServiceGrpc.SecurityServiceImplBase {
    ...
    private final Function<RefreshSecurityContext, RefreshTokenResponse> refreshTokenStrategyBasedFlow;
    ...
    public void refresh(RefreshTokenRequest request, StreamObserver<RefreshTokenResponse> responseObserver) {
        responseObserver.onNext(refreshTokenStrategyBasedFlow.apply(RefreshSecurityContext.from(request)));
        responseObserver.onCompleted();
    }
}
