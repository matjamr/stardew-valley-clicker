...
import com.mat.jamr.gameservice.service.assets.create.consumers.AssetFileAppender;
import com.mat.jamr.gameservice.service.assets.create.consumers.SaveAssetInDbConsumer;
...
@Configuration
public class CreateAssetBeanConfig {
