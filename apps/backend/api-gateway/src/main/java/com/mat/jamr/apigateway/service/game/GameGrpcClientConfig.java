...
public class GameGrpcClientConfig {
    ...
    @Bean
    public ShopServiceGrpc.ShopServiceBlockingStub shopServiceClient(GrpcChannelFactory channels) {
        return ShopServiceGrpc.newBlockingStub(channels.createChannel("game-service"));
    }
}
